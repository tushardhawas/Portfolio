...
function Header() {
  return (
    <header className="header">
      ...
      <nav>
        <a
          href="https://mail.google.com/mail/?view=cm&fs=1&to=tushardhawasssd@gmail.com"
          target="_blank"
        >
          {" "}
          <svg
        ...
        <a href="https://github.com/tushardhawas" target="_blank">
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <a href="https://www.linkedin.com/in/tushardhawas/" target="_blank">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
